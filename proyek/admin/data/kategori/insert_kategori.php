                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="">
                        <div class="container">
                                ...
                                <input name="kategori" type="text" class="form-control form-control-sm" id="" placeholder="" style="width: 300px;">
                            <br>
                            &nbsp;
                    ...
                    if ($kirim) {
                        ...
                        echo "<script>window.location='tables_kategori.php';</script>";
