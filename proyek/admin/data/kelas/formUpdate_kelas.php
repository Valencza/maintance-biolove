    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				$id_kelas = $_GET['id_kelas']; //mengambil id yang ingin diubah

				//menampilkan barang berdasarkan id
				$data = mysqli_query($koneksi, "SELECT * FROM tbl_kelas WHERE id_kelas = '$id_kelas'");
				...
				?>
                    ...
                    <form method="post" action="proses_edit.php" enctype="multipart/form-data">
                        ...
                        <label class="form-label">Gambar :</label>
                                <input name="gambar" type="file" class="form-control form-control-sm" id="" value="<?= $row['gambar']; ?>" placeholder="" style="height: 35px;">
                            <br>
                                <label for="" class="form-label">Kelas :</label>
                                <input name="kelas" type="" class="form-control form-control-sm" id=""  value="<?= $row['kelas']; ?>" placeholder="">
                            <br>
                                <label for="" class="form-label">Keterangan :</label>
                                <textarea name="keterangan" class="form-control form-control-sm" id="keterangan"><?php echo $row['keterangan']; ?></textarea>
                            <br>
                                &nbsp;
