        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Data Kelas</p>

                    <!-- form insert -->
                    <form method="post" action="proses_insert.php" enctype="multipart/form-data">
                        <div class="container"> 
                            <label>Gambar</label>
                            <input class="form-control form-control-sm" type="file" name="gambar" id="myFile" style=" height: 35px;">
                        <br>
                            <label for="" class="form-label">Kelas :</label>
                            <input name="kelas" type="text" class="form-control form-control-sm" id="" placeholder="" style="">
                        <br>
                            <label for="" class="form-label">Keterangan :</label>
                            <input name="keterangan" type="text" class="form-control form-control-sm" id="" placeholder="" style="">
                        <br>
                        &nbsp;
