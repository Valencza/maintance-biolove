    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				$id_mapel = $_GET['id_mapel']; //mengambil id yang ingin diubah

				//menampilkan barang berdasarkan id
				$data = mysqli_query($koneksi, "SELECT * FROM tbl_mapel WHERE id_mapel = '$id_mapel'");
				...
				?>
                    ...
                    <form method="post" action="">
                        ...
                        <input type="hidden" name="id_mapel" value="<?= $row['id_mapel']; ?>">
                                ...
                                <input name="mapel" type="text" class="form-control form-control-sm" value="<?= $row['mapel']; ?>" id="" placeholder="" style="width: 300px;">
                            <br>
                                &nbsp;
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        mysqli_query($koneksi, "UPDATE tbl_mapel SET mapel='$mapel' WHERE id_mapel='$id_mapel'") or die(mysqli_error($koneksi));
