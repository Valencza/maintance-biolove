        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Data Mata Pelajaran</p>

                    <!-- form insert -->
                    <form method="post" action="">
                        <div class="container">
                                <label for="" class="form-label">Mata Pelajaran :</label>
                                <input name="mapel" type="text" class="form-control form-control-sm" id="" placeholder="" style="width: 300px;">
                            <br>
                            &nbsp;
                    ...
                    if ($kirim) {
                        ...
                        echo "<script>window.location='tables_mapel.php';</script>";
