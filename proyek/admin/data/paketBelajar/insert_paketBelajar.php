        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Data Materi</p>
                    ...
                    <form method="post" action="">
                        <div class="container"> 
                            ...
                            <br>
                                ...
                                <input name="nama" type="text" class="form-control form-control-sm" id="" placeholder="" ></input>
                            <br>
                                <label for="" class="form-label">Materi :</label>
                                <textarea name="materi" type="" class="form-control form-control-sm" id="" placeholder="" style="height: 170px;"></textarea>
                            <br>
                            &nbsp;
                    ...
                    @$query = "INSERT INTO tbl_paketbelajar (id_paketBelajar, id_kategori, id_kelas, id_mapel, nama, materi) VALUES ('', '$id_kategori', '$id_kelas', '$id_mapel', '$nama','$materi')";
