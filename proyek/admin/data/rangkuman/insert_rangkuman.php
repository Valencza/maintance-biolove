        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Data Rangkuman</p>
                    ...
                    <form method="post" action="">
                        ...
                        <label class="form-label">Kategori :</label>
                            ...
                            <br>
                                ...
                                <input name="judul" type="" class="form-control form-control-sm"  id="" placeholder="" ></input>
                            <br>
                                <label for="" class="form-label">Rangkuman :</label>
                                <textarea name="rangkuman" type="" class="form-control form-control-sm" style="height: 170px;" id="" placeholder="" ></textarea>
                            <br>
                            &nbsp;
                    ...
                    @$query = "INSERT INTO tbl_rangkuman (id_rangkuman, id_kategori, id_kelas, id_mapel, judul, rangkuman) VALUES ('', '$id_kategori','$id_kelas','$id_mapel','$judul','$rangkuman')";
                
                    if ($kirim) {

                        $hasil = mysqli_query($koneksi,$query);

                        echo "<script>window.location='tables_rangkuman.php';</script>";
