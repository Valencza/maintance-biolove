        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Data Rekomendasi</p>
                    ...
                    <form method="post" action="">
                        ...
                        <label class="form-label">Kategori :</label>
                            ...
                            <br>
                                ...
                                <textarea name="rekomendasi" type="" class="form-control form-control-sm" id="" placeholder="" ></textarea>
                            <br>
                            &nbsp;
                    ...
                    @$query = "INSERT INTO tbl_rekomendasi (id_rekomendasi, id_kategori, id_kelas, id_mapel, rekomendasi) VALUES ('', '$id_kategori','$id_kelas','$id_mapel','$rekomendasi')";
                
                    if ($kirim) {

                        $hasil = mysqli_query($koneksi, $query);

                        echo "<script>window.location='tables_rekomendasi.php';</script>";
