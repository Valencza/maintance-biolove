...
<body id="page-top">
    ...
    <div class="container">
        ...
        <label for="aktif" class="form-label">Status soal aktif:</label>
        ...
        <input type="submit" name="submit" class="btn btn-success float-end" value="Tambah Detail">
    </div>
</form>
...
if (isset($_GET['id_soal'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Insert data into tbl_soal_detail
        $insertDetailQuery = "INSERT INTO tbl_soal_detail (id_soal, soal, a, b, c, d, kunci_jawaban, aktif)
                            VALUES ('$id_soal', '$soal', '$a', '$b', '$c', '$d', '$jawaban_benar', '$aktif')";

        $resultDetail = mysqli_query($koneksi, $insertDetailQuery);

        // Check if the query is successful
        if ($resultDetail) {
            echo "<script>alert('Detail data inserted successfully');</script>";
        } else {
            echo "<script>alert('Failed to insert detail data');</script>";
        }

        // Redirect back to the detail page
        echo "<script>window.location='detail_soal.php?id_soal=$id_soal';</script>";
    }
} else {
