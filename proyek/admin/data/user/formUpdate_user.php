                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="">
                        ...
                        <input type="hidden" name="id_user" value="<?= $data['id_user']; ?>">
                                ...
                                <input name="username" type="text" class="form-control form-control-sm" value="<?= $data['username']; ?>" id="" placeholder="">
                            <br>
                                <label for="" class="form-label">Nama Lengkap :</label>
                                <input name="nama_lengkap" type="text" class="form-control form-control-sm" value="<?= $data['nama_lengkap']; ?>" id="nama_lengkap" placeholder="">
                            <br>
                                <label for="" class="form-label">Email/No.Telpon :</label>
                                <input name="email_no_telp" type="text" class="form-control form-control-sm" value="<?= $data['email_no_telp']; ?>" id="email_no_telp" placeholder="">
                            <br>
                                <label for="" class="form-label">Level :</label>
                                <input name="level" type="text" class="form-control form-control-sm" value="<?= $data['level']; ?>" id="level" placeholder="">
                            <br>
                                &nbsp;
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        mysqli_query($koneksi, "UPDATE tbl_user SET username='$username', nama_lengkap='$nama_lengkap', email_no_telp='$email_no_telp', level='$level' WHERE id_user='$id_user'") or die(mysqli_error($koneksi));
    
                        //redirect ke halaman index.php
                        echo "<script>alert('data berhasil diupdate.');window.location='tables_user.php';</script>";
