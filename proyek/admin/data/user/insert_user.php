        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Tambah Data User</p>
                    ...
                    <form method="post" action="">
                        <div class="container"> 
                            ...
                            <br>
                                ...
                                <input name="password" type="password" class="form-control form-control-sm" id="" placeholder="">
                            <br>
                                <label for="" class="form-label">Nama Lengkap :</label>
                                <input name="nama_lengkap" type="text" class="form-control form-control-sm" id="" placeholder="">
                            <br>
                                <label for="" class="form-label">Email/No.Telpon :</label>
                                <input name="email_no_telp" type="text" class="form-control form-control-sm" id="" placeholder="">
                            <br>
                                <label for="" class="form-label">Level :</label>
                                <input name="level" type="text" class="form-control form-control-sm" id="" placeholder="">
                            <br>
                                &nbsp;
                    ...
                    @$query = "INSERT INTO tbl_user (username, password, nama_lengkap, email_no_telp, level) VALUES ('$username','$hashedPassword','$nama_lengkap','$email_no_telp', '$level')";
                
                    if ($kirim) {

                        $hasil = mysqli_query($koneksi,$query);

                        echo "<script>window.location='tables_user.php';</script>";
