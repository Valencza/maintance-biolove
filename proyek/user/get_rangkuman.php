...
<body>
    ...
    <div class="cover">
        ...
        if (isset($_GET['kategori'])) {
            ...
            if (mysqli_num_rows($resultKategori) > 0) {
                ...
                echo '<p class="judul">Rangkuman ' . $namaKategori . '</p>';
            } else {
                echo '<p class="judul">Rangkuman (Kategori Tidak Ditemukan)</p>';
            }
        } else {
            echo '<p class="judul">Rangkuman (Kategori Tidak Ditemukan)</p>';
        }
    ...
    if (isset($_GET['kategori'])) {
        ...
        $query = "SELECT rangkuman, nama FROM tbl_paketbelajar WHERE id_kategori = (SELECT id_kategori FROM tbl_kategori WHERE kategori = '$kategori')";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            // Tampilkan nama di atas teks rangkuman
            echo '<h1>' . $nama . '</h1><br><br>';
            // Tampilkan rangkuman di tengah layar
            echo '<div style="text-align: left;">' . $rangkuman . '</div><br><br><br>';
            echo '<a class="btn btn-light border-dark" href="latihan.php?kategori=' . $kategori . '" style="border-radius: 35px; margin-left: 800px;">Latihan Soal</a>';
        } else {
