...
<body>
    ...
    <ul class="">
        ...
        <li>&ensp;</li>
        <li><a class="nav" href="#">Rangkuman</a></li>
        <li>&ensp;</li>
            ...
            <?php
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href="get_rangkuman.php?kategori=' . $kategori . '" data-toggle="modal" data-target="#loginModal" class="btn btn-light border-secondary rounded-pill" style="font-size: 20px; font-family: \'Judson\', Helvetica;">&nbsp' . $kategori . '&nbsp</a>&nbsp&nbsp&nbsp';
                        echo '</span>';
