...
<body>
    ...
    <ul class="">
        ...
        <li>&ensp;</li>
        <li>&ensp;</li>
        <li><a class="nav" href="about_us.php">About Us</a></li>
        <li>&ensp;</li>
        <li><a class="nav" href="rangkuman_guest.php">Rangkuman</a></li>
        <li>&ensp;</li>
        <li><a class="nav" href="rekomendasi_guest.php">Rekomendasi</a></li>
        <li>&ensp;</li>
        <li><a class="nav" href="kelas.php">Kelas</a></li>
        <li>&ensp;</li>
        <li><a class="btn btn-warning login" href="login.php"><b>Log In</b></a></li>
    </ul>

    <div class="cover">
        <p class="judul">Rangkuman</p>
    </div>
        ...
        <span class="ms-5 mt-5 mb-5 kategori" style="display: flex; flex-wrap: wrap;">
            ...
            <?php
                ...
                $query = "SELECT k.kategori AS kategori
                          ...
                          JOIN tbl_kategori k ON tr.id_kategori = k.id_kategori"; // Gantilah dengan nama tabel dan kolom yang sesuai
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a onclick="showLoginModal()" class="btn btn-light border-secondary rounded-pill" style="font-size: 20px; font-family: \'Judson\', Helvetica;">&nbsp' . $kategori . '&nbsp</a>&nbsp&nbsp&nbsp';
                        echo '</span>';
