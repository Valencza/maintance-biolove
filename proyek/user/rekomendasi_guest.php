    ...
    <?php
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a onclick="showLoginModal()" class="btn btn-light border-secondary rounded-pill open-youtube-modal" data-kategori="' . $kategori . '" style="font-size: 20px; font-family: \'Judson\', Helvetica;">&nbsp' . $kategori . '&nbsp</a>&nbsp&nbsp&nbsp';
                echo '</span>';
